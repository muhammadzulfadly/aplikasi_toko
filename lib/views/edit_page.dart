...
class _EditProdukState extends State<EditProduk> {
  ...
  Future<void> fetchProduk() async {
    final String apiUrl = "http://192.168.1.19/aplikasi_toko/lib/api/view_data.php";
  ...
  Future<void> updateProduk() async {
    final String apiUrl = "http://192.168.1.19/aplikasi_toko/lib/api/update_data.php";
  ...
  Future<void> hapusProduk() async {
    final String apiUrl = "http://192.168.1.19/aplikasi_toko/lib/api/hapus_data.php";
